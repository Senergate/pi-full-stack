...
assert.equal(PROTOTYPE_CURRENT_REFERENCE_MAX_A.battery, 1.40);
...
// Battery above the 1.40 A reference maximum must saturate at the existing 40 A model maximum.
result = projectLiveScaledBuildingCurrents({
...
// Close to full C300: 0.01 A maps to only about 0.286 A building-equivalent current.
result = projectLiveScaledBuildingCurrents({
