...
assert(classifyVuf(2.01).label === 'Warning', '2.01% rounds to displayed 2.0%, so displayed status must remain Warning.');
assert(classifyVuf(2.06).label === 'Critical', '2.06% displays 2.1%, so status must be Critical.');
