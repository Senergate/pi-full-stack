...
assert(Math.abs(mag.a - 40) < 1e-6, `HP full-scale must target 40 A apparent current, got ${mag.a}`);
...
assert(Math.abs(hp3A - 19.2) < 1e-6, `Fallback HP profile must be non-linear (level3=48% => 19.2 A), got ${hp3A}`);
