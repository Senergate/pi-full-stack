...
close(batteryCurrentRatio(1.04, 1.40), 1.04/1.40);
close(batteryCurrentRatio(1.60, 1.40), 1.0);
close(batteryCurrentRatio(0.01, 1.40), 0.01/1.40);

const scaled = batteryPowerForCurrent({ fullPower: { p: 9000, q: 1000 }, currentA: 1.04, referenceMaxA: 1.40 });
close(scaled.p, 9000 * (1.04/1.40));
close(scaled.q, 1000 * (1.04/1.40));
