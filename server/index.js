...
import ElectricalCalibrationService from './ElectricalCalibrationService.js';

(async () => {
  console.log('START SENERGATE-PI-FULLSTACK');

  await Server.start();
  await Server.init([MqttService, EspService, BatteryService, PicoService, EnergyMeterService, WallboxService, ElectricalCalibrationService]);
})();
